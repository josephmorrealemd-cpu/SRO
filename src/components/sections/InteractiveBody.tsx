...
export default function InteractiveBody() {
  ...
  const [hologramUrl, setHologramUrl] = useState<string>("https://images.unsplash.com/photo-1576086213369-97a306d36557?auto=format&fit=crop&q=80&w=800");
  ...
  const generateHologram = async () => {
    ...
    try {
      ...
      setHologramUrl("https://images.unsplash.com/photo-1576086213369-97a306d36557?auto=format&fit=crop&q=80&w=800");
    } finally {
            ...
            <div className="relative w-full h-full flex items-center justify-center overflow-hidden bg-slate-900/50 rounded-3xl">
              <AnimatePresence mode="wait">
                {isGenerating ? (
                  ...
                  <motion.img 
                    key="hologram"
                    src={hologramUrl || "https://images.unsplash.com/photo-1576086213369-97a306d36557?auto=format&fit=crop&q=80&w=800"} 
